      ...
      <div className="min-h-screen bg-white md:px-32">
        ...
        <section className="bg-yellow-100 py-20 px-6 text-center mt-20">
          ...
          <p className="text-gray-700 max-w-3xl mx-auto text-lg leading-relaxed">
            Kurikulum di SMAIT Baitul 'Ilmi dirancang untuk membekali siswa
            dengan keterampilan hidup (life skills) yang aplikatif dan bernilai
            ibadah. Berikut beberapa program unggulannya:
          </p>
        </section>
